...
struct omap5_es2_prcm_regs {
	...
	/* cm2.l4per */
	u32 pad096[111];				/* 4a008ffc */
	u32 cm_l4per_clkstctrl;			/* 4a009000 */
	u32 pad097[1];				/* 4a009004 */
	u32 cm_l4per_dynamicdep;		/* 4a009008 */
	u32 pad098[5];				/* 4a00900c */
	u32 cm_l4per_adc_clkctrl;		/* 4a009020 */
	u32 pad100[1];				/* 4a009024 */
	u32 cm_l4per_gptimer10_clkctrl;		/* 4a009028 */
	u32 pad101[1];				/* 4a00902c */
	u32 cm_l4per_gptimer11_clkctrl;		/* 4a009030 */
	u32 pad102[1];				/* 4a009034 */
	u32 cm_l4per_gptimer2_clkctrl;		/* 4a009038 */
	u32 pad103[1];				/* 4a00903c */
	u32 cm_l4per_gptimer3_clkctrl;		/* 4a009040 */
	u32 pad104[1];				/* 4a009044 */
	u32 cm_l4per_gptimer4_clkctrl;		/* 4a009048 */
	u32 pad105[1];				/* 4a00904c */
	u32 cm_l4per_gptimer9_clkctrl;		/* 4a009050 */
	u32 pad106[1];				/* 4a009054 */
	u32 cm_l4per_elm_clkctrl;		/* 4a009058 */
	u32 pad107[1];				/* 4a00905c */
	u32 cm_l4per_gpio2_clkctrl;		/* 4a009060 */
	u32 pad108[1];				/* 4a009064 */
	u32 cm_l4per_gpio3_clkctrl;		/* 4a009068 */
	u32 pad109[1];				/* 4a00906c */
	u32 cm_l4per_gpio4_clkctrl;		/* 4a009070 */
	u32 pad110[1];				/* 4a009074 */
	u32 cm_l4per_gpio5_clkctrl;		/* 4a009078 */
	u32 pad111[1];				/* 4a00907c */
	u32 cm_l4per_gpio6_clkctrl;		/* 4a009080 */
	u32 pad112[1];				/* 4a009084 */
	u32 cm_l4per_hdq1w_clkctrl;		/* 4a009088 */
	u32 pad113[1];				/* 4a00908c */
	u32 cm_l4per_hecc1_clkctrl;		/* 4a009090 */
	u32 pad114[1];				/* 4a009090 */
	u32 cm_l4per_hecc2_clkctrl;		/* 4a009098 */
	u32 pad115[1];				/* 4a00909c */
	u32 cm_l4per_i2c1_clkctrl;		/* 4a0090a0 */
	u32 pad116[1];				/* 4a0090a4 */
	u32 cm_l4per_i2c2_clkctrl;		/* 4a0090a8 */
	u32 pad117[1];				/* 4a0090ac */
	u32 cm_l4per_i2c3_clkctrl;		/* 4a0090b0 */
	u32 pad118[1];				/* 4a0090b4 */
	u32 cm_l4per_i2c4_clkctrl;		/* 4a0090b8 */
	u32 pad119[1];				/* 4a0090bc */
	u32 cm_l4per_l4per_clkctrl;		/* 4a0090c0 */
	u32 pad1191[3];				/* 4a0090c4 */
	u32 cm_l4per_mcasp2_clkctrl;		/* 4a0090d0 */
	u32 pad120[1];				/* 4a0090d4 */
	u32 cm_l4per_mcasp3_clkctrl;		/* 4a0090d8 */
	u32 pad121[3];				/* 4a0090dc */
	u32 cm_l4per_mgate_clkctrl;		/* 4a0090e8 */
	u32 pad123[1];				/* 4a0090ec */
	u32 cm_l4per_mcspi1_clkctrl;		/* 4a0090f0 */
	u32 pad124[1];				/* 4a0090f4 */
	u32 cm_l4per_mcspi2_clkctrl;		/* 4a0090f8 */
	u32 pad125[1];				/* 4a0090fc */
	u32 cm_l4per_mcspi3_clkctrl;		/* 4a009100 */
	u32 pad126[1];				/* 4a009104 */
	u32 cm_l4per_mcspi4_clkctrl;		/* 4a009108 */
	u32 pad127[1];				/* 4a00910c */
	u32 cm_l4per_gpio7_clkctrl;		/* 4a009110 */
	u32 pad1271[1];				/* 4a009114 */
	u32 cm_l4per_gpio8_clkctrl;		/* 4a009118 */
	u32 pad1272[1];				/* 4a00911c */
	u32 cm_l4per_mmcsd3_clkctrl;		/* 4a009120 */
	u32 pad128[1];				/* 4a009124 */
	u32 cm_l4per_mmcsd4_clkctrl;		/* 4a009128 */
	u32 pad129[1];				/* 4a00912c */
	u32 cm_l4per_msprohg_clkctrl;		/* 4a009130 */
	u32 pad130[1];				/* 4a009134 */
	u32 cm_l4per_slimbus2_clkctrl;		/* 4a009138 */
	u32 pad131[1];				/* 4a00913c */
	u32 cm_l4per_uart1_clkctrl;		/* 4a009140 */
	u32 pad132[1];				/* 4a009144 */
	u32 cm_l4per_uart2_clkctrl;		/* 4a009148 */
	u32 pad133[1];				/* 4a00914c */
	u32 cm_l4per_uart3_clkctrl;		/* 4a009150 */
	u32 pad134[1];				/* 4a009154 */
	u32 cm_l4per_uart4_clkctrl;		/* 4a009158 */
	u32 pad135[1];				/* 4a00915c */
	u32 cm_l4per_mmcsd5_clkctrl;		/* 4a009160 */
	u32 pad136[1];				/* 4a009164 */
	u32 cm_l4per_i2c5_clkctrl;		/* 4a009168 */
	u32 pad1371[1];				/* 4a00916c */
	u32 cm_l4per_uart5_clkctrl;		/* 4a009170 */
	u32 pad1372[1];				/* 4a009174 */
	u32 cm_l4per_uart6_clkctrl;		/* 4a009178 */
	u32 pad1374[1];				/* 4a00917c */
	u32 cm_l4sec_clkstctrl;			/* 4a009180 */
	u32 cm_l4sec_staticdep;			/* 4a009184 */
	u32 cm_l4sec_dynamicdep;		/* 4a009188 */
	u32 pad138[5];				/* 4a00918c */
	u32 cm_l4sec_aes1_clkctrl;		/* 4a0091a0 */
	u32 pad139[1];				/* 4a0091a4 */
	u32 cm_l4sec_aes2_clkctrl;		/* 4a0091a8 */
	u32 pad140[1];				/* 4a0091ac */
	u32 cm_l4sec_des3des_clkctrl;		/* 4a0091b0 */
	u32 pad141[1];				/* 4a0091b4 */
	u32 cm_l4sec_pkaeip29_clkctrl;		/* 4a0091b8 */
	u32 pad142[1];				/* 4a0091bc */
	u32 cm_l4sec_rng_clkctrl;		/* 4a0091c0 */
	u32 pad143[1];				/* 4a0091c4 */
	u32 cm_l4sec_sha2md51_clkctrl;		/* 4a0091c8 */
	u32 pad144[3];				/* 4a0091cc */
	u32 cm_l4sec_cryptodma_clkctrl;		/* 4a0091d8 */
	u32 pad145[9];			  /* 4a0091ec */

	/* cm2.ivahd */
	u32 cm_ivahd_clkstctrl;			/* 4a009200 */
	u32 pad077[7];				/* 4a009204 */
	u32 cm_ivahd_ivahd_clkctrl;		/* 4a009220 */
	u32 pad078[1];				/* 4a009224 */
	u32 cm_ivahd_sl2_clkctrl;		/* 4a009228 */

	/* cm2.cam */
	u32 pad079[53];				/* 4a00922c */
	u32 cm_cam_clkstctrl;			/* 4a009300 */
	u32 pad080[7];				/* 4a009304 */
	u32 cm_cam_iss_clkctrl;			/* 4a009320 */
	u32 pad081[1];				/* 4a009324 */
	u32 cm_cam_fdif_clkctrl;		/* 4a009328 */

	/* cm2.dss */
	u32 pad082[53];				/* 4a0093fc */
	u32 cm_dss_clkstctrl;			/* 4a009400 */
	u32 pad083[7];				/* 4a009404 */
	u32 cm_dss_dss_clkctrl;			/* 4a009420 */

	/* cm2.sgx */
	u32 pad084[55];				/* 4a009124 */
	u32 cm_sgx_clkstctrl;			/* 4a009500 */
	u32 pad085[7];				/* 4a009504 */
	u32 cm_sgx_sgx_clkctrl;			/* 4a009520 */

	/* cm2.l3init */
	u32 pad086[55];				/* 4a009224 */
	u32 cm_l3init_clkstctrl;		/* 4a009600 */

	/* cm2.l3init */
	u32 pad087[9];				/* 4a009604 */
	u32 cm_l3init_hsmmc1_clkctrl;		/* 4a009628 */
	u32 pad088[1];				/* 4a00962c */
	u32 cm_l3init_hsmmc2_clkctrl;		/* 4a009630 */
	u32 pad089[1];				/* 4a009634 */
	u32 cm_l3init_hsi_clkctrl;		/* 4a009638 */
	u32 pad090[7];				/* 4a00963c */
	u32 cm_l3init_hsusbhost_clkctrl;	/* 4a009658 */
	u32 pad091[1];				/* 4a00965c */
	u32 cm_l3init_hsusbotg_clkctrl;		/* 4a009660 */
	u32 pad092[1];				/* 4a009664 */
	u32 cm_l3init_hsusbtll_clkctrl;		/* 4a009668 */
	u32 pad093[3];				/* 4a00966c */
	u32 cm_l3init_p1500_clkctrl;		/* 4a009678 */
	u32 pad094[21];				/* 4a00967c */
	u32 cm_l3init_fsusb_clkctrl;		/* 4a0096d0 */
	u32 pad095[3];				/* 4a0096d4 */
	u32 cm_l3init_ocp2scp1_clkctrl;
	u32 pad200[3660359];			/* 4ae00000 */
...
extern struct omap5_es2_prcm_regs *const prcm;
#else
